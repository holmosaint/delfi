...
class SinglePathwayModel:
    ...
    """
    def __init__(self, parameters, PHOTO=False, feedback_mode=0, RMAX=False,
                 single=False, dt=DT):
...
def get_data_experiment(cluster_id, data_mat, idx_mat,
                        data_label, data_id, data_key, dt=DT):
...
def get_data_pair_lchirp(cluster_id, buffer_time=10000, DATATYPE=0,
                         RESPTYPE=0, dt=DT):
